          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {STARTER_TEMPLATES.map((t) => (
              <button
                ...
                className={`text-left rounded-xl border border-border/40 overflow-hidden bg-gradient-to-br ${t.accent} shadow-lg hover:shadow-xl hover:bg-orange-50 hover:border-orange-300 hover:scale-[1.06] hover:-translate-y-3 cursor-pointer transition-all duration-200 group w-full ${selectedTemplate === t.name ? 'ring-2 ring-primary border-primary/50' : ''}`}
