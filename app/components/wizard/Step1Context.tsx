    ...
    <div className="space-y-5">
      ...
      {wordCount < 20 && (
        <div className="space-y-2">
          <p className="text-[11px] text-muted-foreground/40 text-center font-medium uppercase tracking-wider">Quick start with a template</p>
          <div className="flex gap-2 overflow-x-auto pb-1 -mx-2 px-2 snap-x">
            {STARTER_TEMPLATES.map((t) => (
              ...
              >
                ...
                <p className="text-[10px] text-muted-foreground/40 leading-snug line-clamp-2">{t.description.split('. ')[0]}.</p>
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="space-y-4">
        <div>
          <label
            htmlFor="appName"
            className="flex items-center gap-1.5 text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2"
          >
            <svg className="w-3.5 h-3.5 text-primary/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>
            App Name
          </label>
          <input
            id="appName"
        ...
        <div>
          <label
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2"
          >
            <svg className="w-3.5 h-3.5 text-primary/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h7" /></svg>
            Description
          </label>
